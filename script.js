...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>Chat with TWH AI (Modified by DarkPandat)</h1>
                            <p>Welcome to TWH AI (Modified by DarkPandat)! Start a conversation and explore the amazing capabilities of artificial intelligence. DeepSeek is here to assist you with insightful responses to any question you may have.</p>
                            ...
                            <p>Feel free to ask anything, from simple queries to complex topics, and see how TWH AI (Modified by DarkPandat) handles it. The more you chat, the better it understands and adapts to your needs!</p>
                            <p>Ready to dive into the world of AI? Start typing below to begin your conversation with TWH AI (Modified by DarkPandat)!</p>
                            <p>Made by <a href="https://t.me/infoaimbot" target="_blank">Aimbot</a> | Powered by TWH AI (Modified by DarkPandat)</p>
                        </div>`;
